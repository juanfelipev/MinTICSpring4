...
-- -----------------------------------------------------
-- Table `gestioncitas_db`.`franja`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `gestioncitas_db`.`franja` (
...
-- -----------------------------------------------------
-- Table `gestioncitas_db`.`agenda`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `gestioncitas_db`.`agenda` (
  `idagenda` INT NOT NULL,
  `fecha` DATE NOT NULL,
  `idMedico` INT NOT NULL,
  `idfranja` INT NOT NULL,
  PRIMARY KEY (`idagenda`),
  INDEX `idmedico_fk_idx` (`idMedico` ASC) VISIBLE,
  INDEX `idfranja_fk_idx` (`idfranja` ASC) VISIBLE,
  CONSTRAINT `idmedico_fk`
    FOREIGN KEY (`idMedico`)
    REFERENCES `gestioncitas_db`.`Medicos` (`idMedicos`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `idfranja_fk`
    FOREIGN KEY (`idfranja`)
    REFERENCES `gestioncitas_db`.`franja` (`idfranja`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `gestioncitas_db`.`Citas` (
  ...
  INDEX `idagenda_fk_idx` (`idagenda` ASC) VISIBLE,
  CONSTRAINT `idpaciente_fk`
    FOREIGN KEY (`idPaciente`)
    REFERENCES `gestioncitas_db`.`Pacientes` (`idPaciente`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `idagenda_fk`
    FOREIGN KEY (`idagenda`)
    REFERENCES `gestioncitas_db`.`agenda` (`idagenda`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
